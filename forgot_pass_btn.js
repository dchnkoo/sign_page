...
forgotPassword.onclick = () => {
    ...
    img1.src = 'images/forgot_pass/Frame 37294.png';
    img1.id = 'cfirst';
    
    const img2 = document.createElement('img');
    img2.src = 'images/forgot_pass/Frame 37298.png';
    img2.id = 'csecond';
    
    const img3 = document.createElement('img');
    img3.src = 'images/forgot_pass/Frame 37299.png';
    img3.id = 'cthird';

    const img4 = document.createElement('img');
    img4.src = 'images/forgot_pass/Frame 37301.png';
    img4.id = 'cfourth';
